...
# load the 3 dataset, they will be merged and cleaned
...
# delete columns not interesting for the sake of the analysis
data$prefix <- NULL
data$country <- NULL
data$num <- NULL
data$total.ita.sim <- NULL

# since foreign presence are registered by country and by day we aggregate to obtain only one entry for each day losing information of the country of the visitor
